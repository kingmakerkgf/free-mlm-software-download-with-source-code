                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body add-post">
                            ...
                            <form images="" id="add_deposit_ticket_form" class="row needs-validation" novalidate="">
                                ...
                                <div class="col-lg-6 col-sm-12 mb-3">
                                    ...
                                    <input disabled name="bank_name" value="PNB" class="form-control" type="text" id="user_id">
                                </div>
                                <div class="col-lg-6 col-sm-12 mb-3">
                                    <label for="user_id"> Bank Account Name </label>
                                    <input disabled value="Jamsr Company" name="bank_acc_name" class="form-control" type="text" id="user_id">
                                </div>
                                <div class="col-lg-6 col-sm-12 mb-3">
                                    <label for="user_id"> Bank Account Number </label>
                                    <input disabled value="245210041115" name="bank_acc_num" class="form-control" type="text" id="user_id" placeholder="Bank Account Number" required="">
                                </div>
                                <div class="col-lg-6 col-sm-12 mb-3">
                                    ...
                                    <select class="form-control" name="payment_method">
                                        ...
                                        <option value="Security Bank">Security Bank</option>
                                        <option value="Union Bank of the Philippines">Union Bank of the Philippines</optio>
                                        ...
                                        <option value="East West Banking Corporation">East West Banking Corporation</optio>
                                        ...
                                        <option value="Mindanao Consolidated CoopBank">Mindanao Consolidated CoopBank</opt>
                                ...
                                <div class="col-lg-6 col-sm-12 mb-3">
                                    ...
                                    <input name="amount" class="form-control" id="subject" type="text" placeholder="Amount" required="">
                            ...
                            <label for="message">Upload Payment Image <small>(OR Deposit Slip)</small></label>
                            <form data-form="#add_deposit_ticket_form" class="dropzone" id="dropZoneUploadForm">
                            ...
                            <div class="btn-showcase justify-right">
                                <button data-form="#add_deposit_ticket_form" id="submit_form" class="btn btn-primary" type="submit">Submit ticket</button>
                            </div>
